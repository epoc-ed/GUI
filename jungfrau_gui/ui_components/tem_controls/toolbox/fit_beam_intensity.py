...
def fit_2d_gaussian_roi(im, roi_start_row, roi_end_row, roi_start_col, roi_end_col):
    ...
    linspace_cols = np.linspace(0, n_columns_roi-1, n_columns_roi)  # Equivalent of Eigen::VectorXd::LinSpaced
    ...
    linspace_rows = np.linspace(0, n_rows_roi-1, n_rows_roi)  # Equivalent of Eigen::VectorXd::LinSpaced
