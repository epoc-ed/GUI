...
class RecordTask(Task):
    def __init__(self, control_worker, end_angle=60, filename='RotEDlog_test'):
    ...
    def run(self):
        ...
        print(f'Start logging: {self.filename}.log')
        ...
        # BEAM
        logfile.write(f"# spot_size:               {self.control.tem_status['eos.GetSpotSize']+1}\n")
        logfile.write(f"# alpha_angle:             {self.control.tem_status['eos.GetAlpha']+1}\n")
        # APERTURE
